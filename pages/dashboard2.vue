  ...
  <div id="pageDashboard">
    <v-container grid-list-xl fluid>
      <v-layout row wrap>
        ...
        <v-flex lg4 sm12 xs12>
          <v-widget title="Top Location" content-bg="white">
            <div slot="widget-content">
              <!-- <e-chart
                :path-option="[
                  ['dataset.source', this.chart_pie_json_quotes],
                  ['legend.bottom', '0'],
                  [
                    'color',
                    [
        ...
        <pre>{{ this.chart_pie_json_quotes }}</pre>
      </v-layout>
    </v-container>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    // }
    // locationData() {
    //   return this.chart_pie_json_quotes;
    // }

    doubleX: function() {
      return this.fetch_chart_pie();
    }
  },
  mounted() {
    // alert(JSON.stringify("1" + this.chart_pie_json_quotes));
    // this.fetch_chart_pie();
    // alert(JSON.stringify("3" + this.chart_pie_json_quotes));
  },
  methods: {
    //แสดง chart_pie
    async fetch_chart_pie() {
      await axios
        ...
        .then(response => {
          this.chart_pie_json_quotes = response.data;

          // //แปลง json
          // this.chart_pie_json = JSON.stringify(this.chart_pie);
          // //ลบ "" quotes ออกจากชื่อตัวแปร

          // this.chart_pie_json_quotes = this.chart_pie_json.replace(
          //   /"([^"]+)":/g,
          //   "$1:"
          // );
          alert("2" + this.chart_pie_json_quotes);
          // this.chart_pie_object = JSON.parse(this.chart_pie_json_quotes);
        });
    }
  }
};
